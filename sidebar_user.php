...
<style>
  .locked-sidebar {
    ...
    background-color: #2f4050 !important; /* Explicit background color prevents body gradient bleed */
    z-index: 1030; 
  }
  ...
  .profile-logo {
      ...
      object-fit: cover;
      margin-bottom: 10px;
      border: 2px solid #4e73df; /* Adjusted to user theme color */
  }
  .mini-logo {
      width: 40px;
      height: 40px;
  ...
  <div class="sidebar-collapse">
    <ul class="nav metismenu" id="side-menu">
      ...
      <li class="<?php echo (basename($_SERVER['PHP_SELF']) == 'my_attendance.php') ? 'active' : ''; ?>">
        <a href="my_attendance.php"><i class="fa fa-calendar-check-o"></i> <span class="nav-label">My Attendance</span></a>
      </li>

      <li class="<?php echo (basename($_SERVER['PHP_SELF']) == 'my_account.php') ? 'active' : ''; ?>">
