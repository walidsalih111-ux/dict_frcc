...
<div class="middle-box loginscreen">
    ...
    <div class="ibox-content mb-3">
        ...
        <form id="attendance-form" method="POST" action="attendance_checker.php">
        ...
        Swal.fire({
            ...
            html: `
                <div style="font-size: 0.9rem; color: #676a6c; margin-bottom: 15px;">
                    Please align your face and upper body within the frame Make Sure your Wearing your ID and Proper Attire.
                </div>
                <div style="position: relative; width: 100%; max-width: 400px; margin: 0 auto; overflow: hidden; border-radius: 4px; background: #000;">
            ...
            didOpen: () => {
                ...
                navigator.mediaDevices.getUserMedia({ video: { facingMode: "user" } })
                    ...
                    .catch(function(err) {
                        ...
                        Swal.showValidationMessage('Could not access camera. Please allow camera permissions in your browser.');
                    });
            },
            willClose: () => {
            ...
            preConfirm: () => {
                ...
                if (!cameraStream || !video.videoWidth) {
                    Swal.showValidationMessage('Camera is not ready yet. Please wait or check permissions.');
                    return false;
                }
