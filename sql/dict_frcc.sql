...
(39, 'user39@email.com', 'User 39', 'AFD', 'Basilan', 'Planning Assistant', 'CSB/PNPKI', 44, 'MALE', 'Job Order'),
...
(20, 101, 'User101', '$2y$10$Mmjz1slqJy.WnXZvnvsdr.GLA1YQzMxC37TbThhcP0mCYqsz41D/.', 'user', '2026-04-16 01:32:24'),
...
--
ALTER TABLE `attendance_record`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;

--
-- AUTO_INCREMENT for table `employees`
--
ALTER TABLE `employees`
  MODIFY `emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
